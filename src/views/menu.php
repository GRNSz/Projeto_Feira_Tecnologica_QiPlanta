        ...
        <section class="anuncios">
            ...
            <div class="produto">
                <center>
                    ...
                    <button onclick="window.location.href='./detalhes.php?id=1';">Ver Produtos</button>
                </center>
            </div>
            ...
            <div class="produto" id="plantas">
                <center>
                    ...
                    <button onclick="window.location.href='./detalhes.php?id=2';">Ver Produtos</button>
                </center>
            </div>
            ...
            <div class="produto" id="plantas">
                <center>
                    ...
                    <button onclick="window.location.href='./detalhes.php?id=3';">Ver Produtos</button>
                </center>
            </div>
            ...
            <div class="produto">
                <center>
                    ...
                    <button onclick="window.location.href='./detalhes.php?id=7';">Ver Produtos</button>
                </center>
            </div>
            ...
            <div class="produto">
                <center>
                    ...
                    <button onclick="window.location.href='./detalhes.php?id=9';">Ver Produtos</button>
                </center>
            </div>
            ...
            <div class="produto">
                <center>
                    ...
                    <button onclick="window.location.href='./detalhes.php?id=10';">Ver Produtos</button>
                </center>
            </div>
